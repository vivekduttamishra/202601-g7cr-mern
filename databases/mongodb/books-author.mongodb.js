...
const createAuthors = () => db.authors.insertMany([
    {
        "name": "Arundhati Roy",
...
const createBooks = () => db.books.insertMany([
    {
...
const getBookInfoWithAuthor = () => db.books.aggregate(

    {
        //join with authors collection to get author details
        $lookup: {
            from: "authors",
            localField: "author",  //book.author
            foreignField: "name",  //author.name
            as: "authorInfo"
        }
    },
    {
    ...
    //unwind the authorInfo array to get individual author details
    {
        $unwind: "$authorInfo"
    },

    //add author details directly to author object
    {
        $addFields: {
    ...
    //remove authorInfo field as we have added required details to book document
    {
        $project: {
            authorInfo: 0,
